<?php
defined('API_PREFIX') || define('API_PREFIX','v1.0');
defined('API_MIDDLEWARE_NAME') || define('API_MIDDLEWARE_NAME','auth.api');
defined('SUCCESS') || define('SUCCESS','200');
defined('UNSUCCESS') || define('UNSUCCESS','101');
defined('UNAUTHORIZED') || define('UNAUTHORIZED',401);
defined('MSG_UNAUTHORIZED') || define('MSG_UNAUTHORIZED','UNAUTHORIZED TO ACCESS');
